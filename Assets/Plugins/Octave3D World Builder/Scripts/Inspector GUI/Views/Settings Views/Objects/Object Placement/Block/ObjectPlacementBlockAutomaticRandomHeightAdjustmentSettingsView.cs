...
{
    [Serializable]
    public class ObjectPlacementBlockAutomaticRandomHeightAdjustmentSettingsView : SettingsView
    {
        #region Private Variables
        [NonSerialized]
        private ObjectPlacementBlockAutomaticRandomHeightAdjustmentSettings _settings;
        #endregion
